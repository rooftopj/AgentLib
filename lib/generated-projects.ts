...
import project1Meta from "@/content/projects/claude-code-context-management/project.json";
import project2Meta from "@/content/projects/claude-code-memory/project.json";
...
export const generatedProjectModules: Array<{
  ...
  { meta: project2Meta, sections: [{"id":"先给结论","title":"先给结论"},{"id":"memory-家族","title":"Memory 家族"},{"id":"auto-memory-主轴","title":"auto-memory 主轴"},{"id":"写入什么时候触发","title":"写入什么时候触发"},{"id":"写入什么内容","title":"写入什么内容"},{"id":"存储形态","title":"存储形态"},{"id":"冲突与更新","title":"冲突与更新"},{"id":"召回什么时候触发","title":"召回什么时候触发"},{"id":"怎么检索","title":"怎么检索"},{"id":"session-memory","title":"Session Memory"},{"id":"autodream","title":"autoDream"},{"id":"team-memory-和-agent-memory","title":"Team Memory 和 Agent Memory"}] },
